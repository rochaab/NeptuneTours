...
<head>
    ...
    <style>
        html {
            /* Remove scroll-behavior: smooth, as it can break JS snapping */
...
<section id="landing" class="relative h-screen bg-cover bg-center overflow-hidden flex flex-col">
   ...
   <div class="relative flex-1 flex flex-col justify-center items-center px-4 sm:px-6 md:px-16 xl:px-56 text-white z-10">
    <div class="flex flex-col md:flex-row justify-between items-center md:items-start w-full max-w-screen-2xl gap-6 md:gap-12 mt-12">
        <!-- Adjusted gap / margin for better responsiveness -->
         <div class="flex flex-col md:flex-row justify-between items-center md:items-start w-full max-w-screen-2xl gap-6 md:gap-12 mt-12">
            <div class="w-full md:w-3/5 text-center sm:text-center md:text-left px-2 sm:px-4">
            <h1 class="text-3xl sm:text-4xl md:text-6xl xl:text-8xl font-semibold font-Eczar leading-tight mb-4 md:pr-16 xl:pr-32" data-aos="fade-right">
                    Neptune Tours and Travels
                </h1>
                <div data-aos="fade-right">
                    <!-- Reduced padding on mobile to avoid overlap -->
                 <p class="text-sm sm:text-base md:text-lg leading-tight font-Anek md:pr-16 xl:pr-32 mb-4 md:mb-8">
                ...
                <div class="text-center md:text-left">
                        <a href="#tours" data-aos="fade-right" class="inline-block bg-white text-[#080c24] px-4 py-2 sm:px-6 rounded-lg text-sm sm:text-lg md:text-xl font-semibold font-Anek hover:bg-blue-100 transition duration-300">
                        Explore Tours
                    </a>
                </div>
            </div>
               <!-- Desktop QR Section -->
        <div class="hidden md:flex flex-col bg-white/20 backdrop-blur-sm text-white rounded-xl p-6 shadow-lg w-full md:w-[22rem] mt-8" data-aos="fade-left">
            <h2 class="text-xl font-Eczar font-bold mb-2 text-center">Guest Registration & Feedback</h2>
            <p class="text-sm text-center mb-6">
                Scan the QR codes below to fill out our guest form and provide feedback for your experience.
            </p>
            <div class="flex justify-between gap-4">
                <div class="text-center">
                    <div class="bg-white p-2 rounded-lg mb-2 border">
                        <img src="{{ asset('images/qrguestform.png') }}" alt="Guest Fill Up Form QR Code" class="w-28 h-28 mx-auto">
                    </div>
                    <p class="font-Eczar font-semibold text-xs">Guest Form</p>
                </div>
                <div class="text-center">
                    <div class="bg-white p-2 rounded-lg mb-2 border">
                        <img src="{{ asset('images/qrfeedback.png') }}" alt="Guest Feedback QR Code" class="w-28 h-28 mx-auto">
                    </div>
...
<!-- Mobile QR Section -->
<div class="md:hidden w-full flex justify-center mt-8 px-4">
    <div class="flex flex-col bg-white/20 backdrop-blur-sm text-white rounded-xl p-4 shadow-lg w-full max-w-sm">
        ...
        <div class="flex flex-wrap justify-between gap-4">
            <div class="text-center flex-1 min-w-[40%]">
                <div class="bg-white p-2 rounded-lg mb-2 border">
                    <img src="{{ asset('images/qrguestform.png') }}" alt="Guest Fill Up Form QR Code" class="w-20 h-20 mx-auto">
                </div>
                <p class="font-Eczar font-semibold text-xs">Guest Form</p>
            </div>
            <div class="text-center flex-1 min-w-[40%]">
                <div class="bg-white p-2 rounded-lg mb-2 border">
                    <img src="{{ asset('images/qrfeedback.png') }}" alt="Guest Feedback QR Code" class="w-20 h-20 mx-auto">
                </div>
                <p class="font-Eczar font-semibold text-xs">Guest Feedback</p>
            </div>
        </div>
    ...
    <section id="tours" class="w-full flex flex-col justify-center pt-24 bg-[#faf7f2] font-Inter">
        <div class="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 mb-8">
                <div class="tour-item group relative cursor-pointer" data-tour="tourA" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="200">
                    ...
                    <div class="text-black p-[4px]">
                        ...
                        <button class="mt-8 px-6 py-3 border border-[#040823] text-[#040823] hover:text-white rounded-md transition-all duration-300 hover:bg-[#040823] hover:border-[#040823] font-Anek hover:scale-105 hover:shadow-lg explore-trip-button" href="#tours">
                         Explore Trip &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ➜ 
                        </button>
                    </div>
                </div>

                <div class="tour-item group relative cursor-pointer" data-tour="tourB" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="400">
                    <div class="h-[300px] overflow-hidden">
                ...
                <div class="tour-item group relative cursor-pointer" data-tour="tourC" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="600">
                    <div class="h-[300px] overflow-hidden">
                ...
                <div class="tour-item group relative cursor-pointer" data-tour="tourD" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="800">
                    <div class="h-[300px] overflow-hidden">
            ...
            <div id="tour-details" class="hidden flex flex-col lg:flex-row h-auto lg:h-[calc(100vh-350px)]">
                <button id="back-button" class=""></button>
                     <div class="w-full lg:w-1/3 min-h-[300px] lg:min-h-[550px]">
                    <div id="tour-details-content" class="relative overflow-visible h-full touch-pan-x"></div>
                </div>
               <div class="map-container relative w-full lg:w-2/3 min-h-[300px] sm:min-h-[400px] md:min-h-[500px] lg:h-[550px] flex justify-center">
                    ...
                    <div id="map-info" class="hidden">
                        <div class="relative">
                            ...
                            <div id="map-info-image-container" class="overflow-hidden max-h-[350px]"></div>
    ...
    <section id="contact" class="w-full min-h-screen flex flex-col items-center justify-center text-center p-6 bg-[#10194a] relative font-Anek">
        ...
        <p class="text-white mb-6 max-w-2xl" data-aos="fade-left" data-aos-delay="200">
                ...
                <div class="flex space-x-2 ml-4">
                    <div class="text-center ml-4">
                        <div class="bg-white p-1 rounded mb-1">
                            <img src="{{ asset('images/qrfb.png') }}" alt="Facebook QR Code" class="w-16 h-16">
                        </div>
                        <p class="text-xs font-semibold text-white">Facebook</p>
                    </div>
                    <div class="text-center">
                        <div class="bg-white p-1 rounded mb-1">
                            <img src="{{ asset('images/qrig.png') }}" alt="Instagram QR Code" class="w-16 h-16">
                        </div>
                        <p class="text-xs font-semibold text-white">Instagram</p>
                    </div>
                </div>
            </div>
        </div>
