    ...
    <div class="container mx-auto px-4 py-3">
        <div class="flex justify-between items-center">
            ...
            <div class="site-branding">
                <div class="site-logo">
                    <a href="{{ url('/') }}">
                        <img width="250" height="150" src="{{ asset('images/neptunelogo.png') }}" class="custom-logo w-[120px] sm:w-[150px] md:w-[180px] lg:w-[210px] xl:w-[240px] 2xl:w-[280px] transition-all duration-500" alt="Neptune Tours and Travels">
                    </a>
                </div>
            </div>
            ...
            <!-- Navigation Menu -->
                <nav id="site-navigation" class="hidden md:flex flex-1 justify-end ml-4" aria-label="Primary menu">
                    <ul class="flex space-x-6 lg:space-x-12 xl:space-x-20">
